...
SOURCES = z-sim.c flight-computer.c physics.c pressure_sensor.c resample-optimal.c coord.c mat.c vec.c $(ZIGGURAT_SOURCES)
ZIGGURAT_HEADERS = ziggurat/random.h
HEADERS = fc.h interface.h particle.h physics.h pressure_sensor.h resample.h coord.h mat.h vec.h gprob.h compiler.h $(ZIGGURAT_HEADERS)
